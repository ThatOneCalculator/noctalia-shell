...
Item {
  ...
  Component {
    ...
    Rectangle {
      ...
      border.color: Settings.data.bar.showOutline ? Style.capsuleBorderColor : Qt.alpha((workspaceModel.isFocused ? "#c4a7e7" : (groupHoverHandler.hovered ? Color.mHover : Color.mOutline)), root.groupedBorderOpacity)
          ...
          delegate: Item {
            ...
            IconImage {
              ...
              Rectangle {
                ...
                height: 4
                color: modelData.isFocused ? "#c4a7e7" : Color.mHover
