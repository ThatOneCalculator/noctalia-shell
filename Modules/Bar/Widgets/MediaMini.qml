...
Item {
  ...
  // 8% of total width
  readonly property real minWidth: Math.max(1, screen.width * 0.08)
  ...
  Rectangle {
    ...
    width: (barPosition === "left" || barPosition === "right") ? Math.round(Style.baseWidgetSize * 0.8 * scaling) : (rowLayout.implicitWidth + Style.marginS * 2 * scaling)
